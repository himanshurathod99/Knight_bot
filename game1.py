...
def games(run, sound):
    ...
    hearts = [pygame.image.load("heart/1.png"), pygame.image.load("heart/11.png"), pygame.image.load("heart/10.png"),pygame.image.load("heart/9.png"), pygame.image.load("heart/8.png"), pygame.image.load("heart/7.png"),pygame.image.load("heart/6.png"), pygame.image.load("heart/5.png"), pygame.image.load("heart/4.png"),pygame.image.load("heart/3.png"), pygame.image.load("heart/2.png")]
    portal = pygame.image.load('image/portal.png')
    gameover = pygame.image.load("bg/7.png")
    winner = pygame.image.load("bg/8.jpg")
    ...
    class players(object):
        ...
        def draws(self,window):
            ...
            if ghost.view == False:
                window.blit(winner, (0,62))
                pygame.display.update()

    def drawgames():
        window.blit(bg, (0, 0))
        text = fonts.render('HIT: ' + str(play.score), 1, (255, 255, 255))
        window.blit(text, (280, 10))
        play.draws(window)
        ghost.draw(window)
        for bullet in bullets:
            bullet.drawing(window)
        window.blit(hearts[play.i], (0, 0))
        pygame.display.update()
    ...
    class Ghostplay(object):
        ...
        def draw(self, window):
            ...
            if self.view:
                ...
                pygame.draw.rect(window, (0, 128, 0), (self.border[0] - 20, self.border[1] - 20, 100 - (5 * (20 - self.life)),10))  #to make green life bar above the enemy and decrease withself.border = (self.x + 20, self.y + 5, 28, 60)
